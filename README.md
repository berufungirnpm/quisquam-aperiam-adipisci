...
# @berufungirnpm/quisquam-aperiam-adipisci

This plugin uses [terser](https://github.com/terser/terser) to minify/minimize your JavaScript.

## Getting Started

Webpack v5 comes with the latest `@berufungirnpm/quisquam-aperiam-adipisci` out of the box. If you are using Webpack v5 or above and wish to customize the options, you will still need to install `@berufungirnpm/quisquam-aperiam-adipisci`. Using Webpack v4, you have to install `@berufungirnpm/quisquam-aperiam-adipisci` v4.

To begin, you'll need to install `@berufungirnpm/quisquam-aperiam-adipisci`:

```console
npm install @berufungirnpm/quisquam-aperiam-adipisci --save-dev
```

or

```console
yarn add -D @berufungirnpm/quisquam-aperiam-adipisci
```

or

```console
pnpm add -D @berufungirnpm/quisquam-aperiam-adipisci
```
...
```js
const TerserPlugin = require("@berufungirnpm/quisquam-aperiam-adipisci");
...
> **Warning**
>
> If you use **Circle CI** or any other environment that doesn't provide real available count of CPUs then you need to setup explicitly number of CPUs to avoid `Error: Call retries were exceeded` (see [#143](https://github.com/berufungirnpm/quisquam-aperiam-adipisci/issues/143), [#202](https://github.com/berufungirnpm/quisquam-aperiam-adipisci/issues/202)).
...
[npm]: https://img.shields.io/npm/v/@berufungirnpm/quisquam-aperiam-adipisci.svg
[npm-url]: https://npmjs.com/package/@berufungirnpm/quisquam-aperiam-adipisci
[node]: https://img.shields.io/node/v/@berufungirnpm/quisquam-aperiam-adipisci.svg
[node-url]: https://nodejs.org
[tests]: https://github.com/berufungirnpm/quisquam-aperiam-adipisci/workflows/@berufungirnpm/quisquam-aperiam-adipisci/badge.svg
[tests-url]: https://github.com/berufungirnpm/quisquam-aperiam-adipisci/actions
[cover]: https://codecov.io/gh/webpack-contrib/@berufungirnpm/quisquam-aperiam-adipisci/branch/master/graph/badge.svg
[cover-url]: https://codecov.io/gh/webpack-contrib/@berufungirnpm/quisquam-aperiam-adipisci
[discussion]: https://img.shields.io/github/discussions/webpack/webpack
[discussion-url]: https://github.com/webpack/webpack/discussions
[size]: https://packagephobia.now.sh/badge?p=@berufungirnpm/quisquam-aperiam-adipisci
[size-url]: https://packagephobia.now.sh/result?p=@berufungirnpm/quisquam-aperiam-adipisci
